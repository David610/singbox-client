module app.singboxclient/vpn_core/native/singbox-go

go 1.24.7

// PINNED. Do not change to a branch, `latest`, or a pseudo-version without
// updating packages/vpn_core/UPSTREAM_VERSION.md and re-running both
// build_android.sh and build_ios.sh to regenerate libbox.aar /
// Libbox.xcframework from the new pin. See docs/ARCHITECTURE.md
// "Pinning the core".
