// Tests for the document-level ProfileCredentialStore API in
// lib/app/utils/credential_store.dart (restored after merge b1c9517 kept
// only the static CredentialStore half). Ported from the pre-merge
// credential_store_test.dart at commit 829e1de.
import 'dart:convert';
import 'dart:io';
